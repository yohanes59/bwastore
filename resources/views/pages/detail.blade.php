                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img src="{{ asset('templates/images/icon-testimonial-1.png') }}"
                                ...
                                <li class="media my-4">
                                    <img src="{{ asset('templates/images/icon-testimonial-2.png') }}"
                                        class="mr-3 rounded-circle" alt="" />
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img src="{{ asset('templates/images/icon-testimonial-3.png') }}"
                                        class="mr-3 rounded-circle" alt="" />
                                    <div class="media-body">
...
@push('addon-script')
    <script src="{{ asset('templates/vendor/vue/vue.j') }}s"></script>
    <script>
        var gallery = new Vue({
            el: "#gallery",
            mounted() {
            ...
            data: {
                ...
                photos: [{
                        id: 1,
                        url: "{{ asset('templates/images/product-details-1.jpg') }}",
                    },
                    {
                        id: 2,
                        url: "{{ asset('templates/images/product-details-2.jpg') }}",
                    },
                    {
                        id: 3,
                        url: "{{ asset('templates/images/product-details-3.jpg') }}",
                    },
                    {
                        id: 4,
                        url: "{{ asset('templates/images/product-details-4.jpg') }}",
                    },
                ],
            },
            methods: {
