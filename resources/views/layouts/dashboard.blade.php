...
<body>
            ...
            <div class="border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{ route('dashboard-product') }}"
                        ...
                        Products</a>
                    {{-- dashboard-product* =>ditaruh bintang karena mengambil url yang setelahnya product juga --}}
                    ...
                    <a href="{{ route('dashboard-settings-store') }}"
                        class="list-group-item list-group-item-action {{ request()->is('dashboard-settings-store*') ? 'active' : '' }}">Store
                        Settings</a>
                    <a href="{{ route('dashboard-settings-account') }}"
                        class="list-group-item list-group-item-action {{ request()->is('dashboard-settings-account*') ? 'active' : '' }}">My
                        Account</a>
                    <a href="{{ route('logout') }}"
                        ...
                        <ul class="navbar-nav ml-auto d-none d-lg-flex">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-inline-block mt-2" href="{{ route('cart') }}">
                                    ...
                                    @endphp
                                    @if ($carts > 0)
                                        <img src="{{ asset('templates/images/icon-cart-filled.svg') }}"
                                            alt="" />
                                        <div class="cart-badge">{{ $carts }}</div>
                                    @else
                                        <img src="{{ asset('templates/images/icon-cart-empty.svg') }}"
                                            alt="" />
                                    @endif
                                </a>
                            </li>
    ...
    <script src="{{ asset('templates/vendor/jquery/jquery.slim.min.js') }}"></script>
